...
<div id="hd">
    ...
    <div id="head_nav">
        ...
        <div id="logo">
            <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_THEME_IMG_URL ?>/nimg/dassm.png"
        ...
        <nav id="gnb">
            ...
            <div class="gnb_wrap">
                ...
                <div class="app_menu">
                    <h3 class="app_down_btn"><a href="javascript:alert('준비중입니다');">앱 다운로드</a></h3>


                    <div class="navTrigger__wrap gnb_menu_btn1">
                ...
                <div id="gnb_all">
                    ...
                    <button type="button" class="gnb_close_btn"><i class="fa-solid fa-xmark"></i></button>
                </div>
